function [elements,nodesNew,nodosFluidos,elementsBarra,EBindex,intRelations] = gapInterseccionesEBZ1(nodesINTindex,nodesNew,gap,elementsPlusY,elementsPlusZ,elements,nodosFluidos,elementsBarra,EBindex)
