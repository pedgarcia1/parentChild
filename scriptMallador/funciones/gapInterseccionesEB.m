function [elements,nodesNew,nodosFluidos,elementsBarra,EBindex,intRelations] = gapInterseccionesEB(nodesINTindex,nodesNew,gap,elementsPlusY,elementsPlusZ,elements,nodosFluidos,elementsBarra,EBindex)
