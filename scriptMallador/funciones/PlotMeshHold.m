function PlotMeshHold(coordinates,nodes,show,color,opacity)
%--------------------------------------------------------------------------
% Purpose:
...
%         figure
    ...
    elseif nnel==8  % solid in 3D
        ...
        cellfun(@patch,repmat({'Vertices'},1,nel),XYZ,.......
            ...
            repmat({'FaceColor'},1,nel),repmat({color},1,nel),repmat({'FaceAlpha'},1,nel),repmat({opacity},1,nel));
        view(3)
