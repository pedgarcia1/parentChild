function [elements,nodesNew,nodosFluidos,elementsBarra,EBindex,intRelations] = gapInterseccionesEBZ3(nodesINTindex,nodesNew,gap,elementsPlusY,elementsPlusZ,elements,nodosFluidos,elementsBarra,EBindex)
