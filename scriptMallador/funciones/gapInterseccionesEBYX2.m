function [elements,nodesNew,nodosFluidos,elementsBarra,EBindex,intRelations] = gapInterseccionesEBYX2(nodesINTindex,nodesNew,gap,elementsPlusY,elementsPlusX,elements,nodosFluidos,elementsBarra,EBindex)
