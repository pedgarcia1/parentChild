function [elements,nodesNew,nodosFluidos,elementsBarra,EBindex,intRelations] = gapInterseccionesEBYX4(nodesINTindex,nodesNew,gap,elementsPlusY,elementsPlusX,elements,nodosFluidos,elementsBarra,EBindex)
