function [elements,nodesNew,nodosFluidos,elementsBarra,EBindex,intRelations] = gapInterseccionesEBZ2(nodesINTindex,nodesNew,gap,elementsPlusY,elementsPlusZ,elements,nodosFluidos,elementsBarra,EBindex)
