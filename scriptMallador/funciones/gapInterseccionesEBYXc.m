function [elements,nodesNew,nodosFluidos,elementsBarra,EBindex,intRelations] = gapInterseccionesEBYXc(nodesINTindex,nodesNew,gap,elementsPlusY,elementsPlusX,elements,nodosFluidos,elementsBarra,EBindexY,EBindexX)
