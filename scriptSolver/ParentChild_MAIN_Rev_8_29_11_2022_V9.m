...
nombreCorrida     = 'ParentChild_Pedro_SRV_1'; % Nombre de la corrida. La corrida se guarda en la carpeta "Resultado de corridas" en una subcarpeta con este nombre.

cargaDatos     = 'load'; % Forma en la que se cargan las propiedades de entrada. "load" "test" "default" "change".
archivoLectura = 'ParentChild_Pedro_9.txt'; % Nombre del archivo con las propiedades de entrada. 
