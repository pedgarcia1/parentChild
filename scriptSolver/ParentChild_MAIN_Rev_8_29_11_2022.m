...
direccionRestart   = 'C:\Users\npastore\Desktop\Parent-Child Rev.8 29-11-2022\Parent-Child Rev.8 29-11-2022\Resultados de corridas\ParentChild_1_11\';
propiedadesRestart = 'resultadosFinISIP_1_ParentChild_1_11.mat';

% Variables del post - procesado.
tiempoArea      = 200; % Tiempo en el que se quiere visualizar la forma del area de fractura.
...
%-------------------------------------------------------------------------%
marca
scaleMeshFactor = 72e3/(3.62e5-1.92e5); % cambio anchoX y anchoY para que la fractura no alcance los limites fracturables, 72m de alto 520m de largo
meshInfo = loadMesh(cargaDatos,archivoLectura,scaleMeshFactor); % Carga la malla y genera una estructura con los datos de la misma.
...
bombaProperties      = setBombaProperties3(meshInfo,'off',cargaDatos,archivoLectura,scaleMeshFactor); % Propiedades de la bomba.
